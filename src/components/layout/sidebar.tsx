  ...
  return (
    <>
      ...
      <aside
        ...
        style={{
          background: 'linear-gradient(180deg, #0F3D2B 0%, #0B2E20 100%)',
        ...
        {collapsed ? (
          ...
          <>
            ...
            <div style={{ position: 'relative', zIndex: 1, padding: '26px 22px 16px', display: 'flex', gap: 12, alignItems: 'center' }}>
              <img src="https://pupukkaltim.com/public/assets/files/img/logodasar.png" alt="Pupuk Kaltim"
            ...
            <nav style={{ position: 'relative', zIndex: 1, padding: '4px 14px', display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              {MAIN_NAV.concat(MORE_NAV).map((item) => {
                  ...
                  >
                    ...
                    {active && (
                      <span style={{
                        ...
                        width: 4, height: 20, borderRadius: '0 4px 4px 0', background: '#2FB36B',
                      }} />
                    )}
                  </Link>
                );
      ...
      <nav className="mobile-bottombar" style={{
        ...
        background: '#0F3D2B', display: 'flex', alignItems: 'center',
        ...
        {MAIN_NAV.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href}
              ...
              {active && <span style={{ position: 'absolute', top: 0, left: '30%', right: '30%', height: 2, borderRadius: '0 0 2px 2px', background: '#2FB36B' }} />}
            </Link>
          );
        })}
      ...
      {showMore && (
        <div style={{
          ...
          <div style={{
            background: '#F5F6F2', borderRadius: '20px 20px 0 0',
            width: '100%', maxWidth: 500, padding: '20px 20px calc(20px + env(safe-area-inset-bottom, 0px))',
            boxShadow: '0 -8px 30px rgba(0,0,0,0.2)',
          }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#73837A', padding: '4px 12px 8px' }}>
                Menu Lainnya
              </div>
              {MORE_NAV.map(item => {
                const active = isActive(item.href);
                return (
                  <Link key={item.href} href={item.href} onClick={() => setShowMore(false)}
                    style={{
                      ...
                      background: active ? '#DFF5E8' : 'transparent',
                      color: active ? '#1F9D5A' : '#152019',
                    }}>
            ...
            <button onClick={() => setShowMore(false)}
              style={{
                ...
                fontSize: 13, fontWeight: 600, color: '#73837A',
              }}>
              Tutup
            </button>
          </div>
